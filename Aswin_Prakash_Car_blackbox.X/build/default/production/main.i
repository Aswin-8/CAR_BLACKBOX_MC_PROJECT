...
void main(void)
{
    ...
    str_write_externaleeprom(0x00,"1010");
    while (1)
    {
        speed=read_adc() / 10.33;
        key= read_digital_keypad(1);
        key2=read_digital_keypad(0);
        ...
        else if(control_flag == 0x02 && key2==0x37 && long_press_delay ++ > 20 )
        {
            TMR2ON=0;
            switch(menu_pos)
            {
        ...
        else if((control_flag==0x15 || control_flag==0x17 || control_flag==0x16 || control_flag==0x02)&& key2 == 0x2F && long_press_delay ++ > 20)
        {
            clear_screen();
            if(gr!=0)
        ...
        else if((control_flag==0x15 || control_flag==0x17 || control_flag==0x16 )&& key2 == 0x37 && long_press_delay ++ > 20)
        {
            clear_screen();
            menu_pos=0;
            strcpy(event,gear[gr]);
